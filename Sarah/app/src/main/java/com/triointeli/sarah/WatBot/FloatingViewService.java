...
public class FloatingViewService extends Service implements View.OnClickListener {
    ...
    private void implementClickListeners() {
        mFloatingWidgetView.findViewById(R.id.close_btn).setOnClickListener(this);
        mFloatingWidgetView.findViewById(R.id.close_button).setOnClickListener(this);
        mFloatingWidgetView.findViewById(R.id.open_button).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.open_button:
                ...
                Intent intent = new Intent(FloatingViewService.this, MainActivityBot.class);
